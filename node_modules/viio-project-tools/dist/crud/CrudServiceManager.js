...
class CrudServiceManager {
    ...
    sendFinding(url, config) {
        return new Promise((resolve, reject) => {
            itrm_tools_1.RequestAxiosCall.get(url, config)
                .then((response) => {
    ...
    sendCreation(url, body, config) {
        return new Promise((resolve, reject) => {
            itrm_tools_1.RequestAxiosCall.post(url, body, config)
                .then((response) => {
    ...
    sendModification(url, modification, config) {
        return new Promise((resolve, reject) => {
            itrm_tools_1.RequestAxiosCall.put(url, Object.assign({}, modification), config)
                .then((response) => {
                resolve(response);
            }).catch((err) => {
                reject(err);
    ...
    sendDestuction(url, config) {
        return new Promise((resolve, reject) => {
            itrm_tools_1.RequestAxiosCall.delete(url, config)
                .then((response) => {
                resolve(response);
            }).catch((err) => {
                reject(err);
